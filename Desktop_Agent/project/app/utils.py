...
logging.basicConfig(filename="Desktop_Agent\\project\\app\\assets\\logs\\Employee_activity.log", level=logging.INFO)

def upload_with_retry(s3_client, file_path, bucket_name, object_name, retries=3, delay=2):
    
    # This will upload the file to AWS S3
...
def is_internet_available(host="8.8.8.8", port=53, timeout=3):
    ...
    # This can check a internet connectivity...
    try:
